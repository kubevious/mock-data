...
import { KubernetesApiData, KubernetesOpenApiResource } from './k8s-api-spec-converter';
import { OpenApiDefinition } from 'k8s-super-client';

export class BaseOpenApiDocumentParser
{
    protected _logger : ILogger;
    private _documentSchemas : Record<string, OpenApiDefinition>;
    ...
    constructor(logger: ILogger,
                ...
                documentSchemas? : Record<string, OpenApiDefinition>)
    {
        this._logger = logger;
    ...
    protected _convertApiResource(path: string, apiResource: KubernetesOpenApiResource, resourceRef: string)
    {
